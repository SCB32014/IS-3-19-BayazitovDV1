...
namespace IS_3_19_BayazitovDV1
{
    public partial class Form1 : Form
    {
        ...
        class CP<T> : Complektation<T>
        {
            ...
            {
                return base.Display() +
               $" Частота процессора: {Chastota}," +
               $" Количество ядер: {NumberCores}," +
               $" Количество потоков: {NumberPotoks}";
            }
        }
